  ...
  return (
    <div className="min-h-screen bg-black">
      <RealStreamingPlayer
        ...
        season={seasonNum}
        episode={episodeNum}
        title={`${show.name} - S${seasonNum.toString().padStart(2, "0")}E${episodeNum.toString().padStart(2, "0")}`}
        ...
        onProgress={() => {}}
        onEpisodeSelect={(season, episode) => router.push(`/tv/${id}/watch?season=${season}&episode=${episode}`)}
        show={show}
      />
    </div>
  )
