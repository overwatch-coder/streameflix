  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content fixed z-50 flex h-auto flex-col bg-gray-950 border-gray-800 text-white",
        ...
        {...props}
      >
        <div className="mx-auto mt-4 h-1.5 w-12 rounded-full bg-gray-700 group-data-[vaul-drawer-direction=bottom]/drawer-content:visible group-data-[vaul-drawer-direction=bottom]/drawer-content:block hidden" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  )
